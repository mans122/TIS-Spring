	...
	<div id="box">
		...
		<div class="commentlist blog-details-comments">
			<h3 class="small-title">
				정한별의 탄생<span class="badge  badge-pill badge-primary">상영중</span>
			</h3>
		...
		<div class="playStory">
			<h4>줄거리</h4>
			<div>태초에 어떤 생물도 존재하지 않았던 지구.. 그러던중 어떤 한 인간이 탄생하게 되는데 그의 이름은 정한별,
				코딩계를 지배할 남자가 태어나게 된것이다. 앞으로 펼처질 그의 운명은??</div>
		</div>
		<!-- //공연정보 줄거리 -->
