	...
	<div id="box">
		...
		<div class="commentlist blog-details-comments">
			<h3 class="small-title">
				<c:out value="${showDetail.s_name}"/> <span class="badge  badge-pill badge-primary">상영중</span>
			</h3>
			<div class="single-comment">
				...
				<div class="single-comment-content">
					...
					<h4>공연정보</h4>
					<p>장르: <c:out value="${showDetail.s_genre}"/></p>
					<p>일시: <fmt:formatDate pattern="yyyy-MM-dd" value="${showDetail.s_s_date}"/> ~ <fmt:formatDate pattern="yyyy-MM-dd" value="${showDetail.s_e_date}"/></p>
					<p>장소: 장충체육관</p>
					<p>사이트: <c:out value="${showDetail.s_sell_link}"/></p>
		...
		<div class="showStory">
			<h4>줄거리</h4>
			<div>
				<c:out value="${showDetail.s_content}"/>
			</div>
		</div>
		<!-- //공연정보 줄거리 -->
			...
			<form action="#">
				<div class="row">
					<div class="col-sm-9 col-lg-9 col-9">
						<textarea placeholder="내용을 입력해주세요." class="form-control" rows="3"
							cols="50"></textarea>
