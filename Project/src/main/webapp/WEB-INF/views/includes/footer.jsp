...
<style>
        ...
        <footer class="footer-area">
            ...
            <!-- Footer Widgets Area -->
            <div class="bg-footer-1  section-padding-xs" data-black-overlay="7">
                <div class="container">
                            ...
                            <div class="single-widget about-widget">
                                ...
                                <ul>
                                    <li>
                                        ...
                                        <p>California Street san Francisco, CA</p>
                                    </li>
                                ...
                                <ul>
                                    <li>
                                        <a href="blog-details.html">
                                            <img src="/resources/images/blog/thumbnails/footer-thumbnail-1.png" alt="footer post">
                                        </a>
                                    </li>
                                </ul>
                            </div>
