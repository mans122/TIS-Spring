          ...
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body">
						...
						<form action="/community/boardRegister" role="form" method="post" name="frm">
	              		...
	              		<div class="form-group">
		              		<label>내용</label>
		              		<textarea class="form-control" rows="200" name="content"></textarea>
		              	</div>
		              	...
		              	<button type="submit" class="btn btn-primary btn-sm" data-oper="register">등록</button>
		              	<button type="button" class="btn btn-primary btn-sm" data-oper="cancel">취소</button>
						</form>
              </div>
            </div>
          </div>
