        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body">
              		<form role="form" action="/community/boardModify" method="post">
              			<input type="hidden" value="${cmboard.b_no }" name="b_no">
              			<input type="hidden" value="${cmboard.writer }" name="writer" >
	              		<div class="form-group">
	              			<label>제목</label>
	              			<input class="form-control" name="title" value="${cmboard.title }">
	              		</div>
	              		<div class="form-group">
		              		<label>내용</label>
		              		<textarea class="form-control" rows="200" name="content">${cmboard.content }</textarea>
		              	</div>

				         <button type="submit" data-oper="modify" class="btn btn-primary btn-sm">등록</button>
							<button type="submit" data-oper="cancel" class="btn btn-primary btn-sm">취소</button>
              		</form>
              </div>
            </div>
          </div>
